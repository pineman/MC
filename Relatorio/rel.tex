...
\subsection*{e)}
	...
	\begin{table}[H]
		...
		\begin{tabular}{c|c|c|c}
			$n$ & $\frac{|e_{n+1}|}{|e_n|^2}$ &  $\frac{|e_{n+1}|}{|e_n|^1}$ & $\frac{|e_{n+1}|}{|e_n|^{\frac{1}{2}}}$ \\\hline
		...
		% btw pineman trocaste as colunas. O Morais disse para avisar.
...
\subsection*{b)}
	...
	Escolhamos, ao acaso, o ponto x = 3. f(3) = TODO (falta-me o resultado porque sou preguiçosa) > 0 , logo há convergência para esse ponto.
